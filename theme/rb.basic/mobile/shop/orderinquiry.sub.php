...
<div id="sod_inquiry">
    <ul>
        ...
        <li>
            ...
            <div class="inquiry_name"><?php echo $ct_name; ?></div>
            <div class="inq_wr">
                <div class="inquiry_price"><?php echo display_price($row['od_receipt_price']); ?></div>
                <div class="inv_status"><?php echo $od_status; ?></div>
            </div>
            <div class="inquiry_inv"><?php echo $od_invoice; ?></div>
        </li>
        <?php
        }
        if ($i == 0)
