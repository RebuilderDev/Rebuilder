            ...
            <div class="inner" style="width:<?php echo $tb_width_inner ?>; <?php echo $tb_width_padding ?>">
                ...
                <ul class="logo_wrap">
                    ...
                    <nav id="cbp-hrmenu" class="cbp-hrmenu pc">
                        ...
                        // === rb 3차 메뉴 전용 함수 사용 ===
                        if (IS_MOBILE()) {
                            $menu_datas = get_rb_menu_db($rb_config['menu_set'], 1, true);
                        } else {
                            $menu_datas = get_rb_menu_db($rb_config['menu_set'], 0, true);
                        }
                        ...
                        ?>
                            <li>
                                ...
                                foreach ((array)$row['sub'] as $row2) {
                                    ...
                                    if ($k == 0) {
                                        // 기존 구조(cb p-hrsub)는 그대로 유지
                                        echo '<div class="cbp-hrsub"><div class="cbp-hrsub-inner"><div><ul class="rb-gnb-depth2">'.PHP_EOL;
                                    }

                                    // 3차 메뉴 권한까지 필터링해서 배열로 모으기
                                    $depth3_list = array();
                                    ...
                                    $has_depth3 = count($depth3_list) > 0;
                                ?>
                                    <li class="rb-gnb-sub-item<?php echo $has_depth3 ? ' has-children' : ''; ?>">
                                        <a href="<?php echo $row2['me_link']; ?>"
                                        target="_<?php echo $row2['me_target']; ?>"
                                        class="rb-gnb-sub-link">
                                            <span><?php echo $row2['me_name']; ?></span>

                                            <?php if ($has_depth3) { ?>
                                            <!-- 3차 메뉴 있는 경우에만 오른쪽 화살표 -->
                                            <span class="rb-gnb-sub-arrow" aria-hidden="true">
                                        ...
                                        <?php if ($has_depth3) { ?>
                                            <div class="rb-gnb-sub-3depth">
                                                <?php foreach ($depth3_list as $row3) { ?>
                                                    <a href="<?php echo $row3['me_link']; ?>"
                                                    target="_<?php echo $row3['me_target']; ?>">
