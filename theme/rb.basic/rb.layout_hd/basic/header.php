                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                ...
                                window.rb_notification_open_view = function(notificationId) {
                                    notificationId = parseInt(notificationId, 10) || 0;
                                    if (!notificationId || !$notificationBox.length) return false;
                                ...
                                $('#notification_top_btn').click(function(event) {
                                ...
                                $('#search_box_wrap, #notification_box_wrap').click(function(event) {
                                    event.stopPropagation(); // Prevent click event from propagating to document
                                });
                                ...
                                $('.rb_notification_delete_all').click(function() {
                                ...
                                $('.rb_notification_back').click(function() {
                                    $('.rb_notification_view').hide();
                                    $('.rb_notification_list').show();
                                    $('.rb_notification_body').scrollTop(0);
                                });
