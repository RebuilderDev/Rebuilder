...
<?php
    ...
    <script>
        function adjustContentPadding() {
            ...
            var sideMenu = document.getElementById('rb_sidemenu_shop');
            if (sideMenu) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (header && window.ResizeObserver) {
                window.rbShopHeaderResizeObserver = new ResizeObserver(adjustContentPadding);
                window.rbShopHeaderResizeObserver.observe(header);
            }
        });
    </script>
