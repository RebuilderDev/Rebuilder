...
<div class="rb-card">
  <div class="rb-hd">
    <div class="rb-ttl">게시물</div>
    <div class="rb-m-btn-wrap">
      <a class="btn rb-badge rb-set-btn" href="<?php echo G5_ADMIN_URL ?>/board_list.php">설정</a>
      <a class="btn rb-badge" href="<?php echo G5_URL ?>/rb/new.php?view=w" target="_blank">더보기</a>
    </div>
    <button class="rb-close" type="button" aria-label="삭제">×</button>
  </div>
  <div class="rb-small">전체 <?php echo rb_nf($post_total) ?>건</div>
  <div class="rb-metrics">
    <div class="left"><?php echo rb_pill('오늘'); ?></div>
    <div class="right"><strong>+<?php echo rb_nf($post_today) ?></strong></div>
  </div>
  <div class="rb-mini">
    <div class="rb-table-wrap">
      <table class="rb-table">
        ...
        <?php } else { foreach($post_list as $r){
        ...
        ?>
          <tr>
            ...
            <td class="rb-col-title"><a href="<?php echo $r['link']; ?>" target="_blank" rel="noopener"><?php echo $r['subject']; ?></a></td>
