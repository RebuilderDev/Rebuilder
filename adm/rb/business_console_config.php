...
<tr><th scope="row">하단 바로가기</th><td><input type="radio" name="bc_footer_link" id="bc_footer_link_1" value="1" <?php echo !empty($bc['bc_footer_link']) ? 'checked' : ''; ?>> <label for="bc_footer_link_1">보이기</label>　<input type="radio" name="bc_footer_link" id="bc_footer_link_0" value="0" <?php echo empty($bc['bc_footer_link']) ? 'checked' : ''; ?>> <label for="bc_footer_link_0">숨기기</label></td></tr>
