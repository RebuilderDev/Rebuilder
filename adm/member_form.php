            ...
            <tbody>
                ...
                <?php for ($i = 1; $i <= 10; $i++) { ?>
                    <tr>
                        ...
                        <td colspan="3"><input type="text" name="mb_<?php echo $i ?>" value="<?php echo get_sanitize_input($mb['mb_' . $i]); ?>" id="mb_<?php echo $i ?>" class="frm_input" size="30" maxlength="255"></td></td>
                    </tr>
                <?php } ?>
